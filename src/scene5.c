...
void Scene5_LoadRoom2(void) {
	...
	ENEMY_Load("ENEMY9.DAT", 1, 22 << 4, 11 << 4, SPRITE_GRAPHICS_ID_ENEMY1_CHAT, SPRITE_GRAPHICS_ID_ENEMY1_PORTAIT, SPRITE_GRAPHICS_ID_ENEMY1_FEET, SPRITE_GRAPHICS_ID_ENEMY1_BODY, SPRITE_GRAPHICS_ID_ENEMY1_HEAD, SPRITE_GRAPHICS_ID_ENEMY1_LARM, SPRITE_GRAPHICS_ID_ENEMY1_RARM, ENEMY_FACING_LEFT, ENEMY_GUN_PISTOL, SPRITE_GRAPHICS_ID_GUN1, SPRITE_GRAPHICS_ID_BULLET1, ENEMY_STATUS_STATIC_SHOOTER, 100);
	ENEMY_Load("ENEMY9.DAT", 2, 33 << 4, 11 << 4, SPRITE_GRAPHICS_ID_ENEMY1_CHAT, SPRITE_GRAPHICS_ID_ENEMY1_PORTAIT, SPRITE_GRAPHICS_ID_ENEMY1_FEET, SPRITE_GRAPHICS_ID_ENEMY1_BODY, SPRITE_GRAPHICS_ID_ENEMY1_HEAD, SPRITE_GRAPHICS_ID_ENEMY1_LARM, SPRITE_GRAPHICS_ID_ENEMY1_RARM, ENEMY_FACING_LEFT, ENEMY_GUN_SHOTGUN, SPRITE_GRAPHICS_ID_GUN2, SPRITE_GRAPHICS_ID_BULLET1, ENEMY_STATUS_STATIC_SHOOTER, 100);
...
void Scene5_Loop(void) {
	...
	VIDEO_StringToScreenBuffer(50, 85, ui->txt_file[UI_TXT_SCN5I]->line[41], FONT_BIG_BLACK);
	...
	switch (engine.room) {
		...
		case 2:// Room 2. Top floor
			...
			break;
		default:
			sprintf(engine.system_error_message1, "Scene5_Loop function error");
	...
	while (engine.ingame) {
		switch (engine.room) {
			...
			case 2:// Room 2. Other floors
				...
				if (enemy[2].action_dead && (enemy[2].action_step == 1)) {
					switch (rand() % 8) {
						case 0:// Nothing
							break;
						case 1:// Medikit
							if (!item[0].is_loaded) ITEM_LoadItem(0, ENTITY_ID_ITEM_MEDIKIT, SPRITE_GRAPHICS_ID_ITEM_MEDIKIT, enemy[2].pos_x, enemy[2].pos_y + 16);
							break;
						case 2:// Grenades
							if (!item[0].is_loaded) ITEM_LoadItem(0, ENTITY_ID_ITEM_GRENADE, SPRITE_GRAPHICS_ID_ITEM_GRENADE, enemy[2].pos_x, enemy[2].pos_y + 16);
							break;
						case 3:// Ammo 3
							if (!item[0].is_loaded) ITEM_LoadItem(0, ENTITY_ID_ITEM_AMMO3, SPRITE_GRAPHICS_ID_ITEM_AMMO3, enemy[2].pos_x, enemy[2].pos_y + 16);
							break;
						case 4:// Ammo 4
							if (!item[0].is_loaded) ITEM_LoadItem(0, ENTITY_ID_ITEM_AMMO4, SPRITE_GRAPHICS_ID_ITEM_AMMO4, enemy[2].pos_x, enemy[2].pos_y + 16);
							break;
						default:
							break;
					}
				...
				if (enemy[5].action_dead && (enemy[5].action_step == 1)) {
					switch (rand() % 8) {
						case 0:// Nothing
							break;
						case 1:// Medikit
							if (!item[1].is_loaded) ITEM_LoadItem(1, ENTITY_ID_ITEM_MEDIKIT, SPRITE_GRAPHICS_ID_ITEM_MEDIKIT, enemy[5].pos_x, enemy[5].pos_y + 16);
							break;
						case 2:// Grenades
							if (!item[1].is_loaded) ITEM_LoadItem(1, ENTITY_ID_ITEM_GRENADE, SPRITE_GRAPHICS_ID_ITEM_GRENADE, enemy[5].pos_x, enemy[5].pos_y + 16);
							break;
						case 3:// Ammo 3
							if (!item[1].is_loaded) ITEM_LoadItem(1, ENTITY_ID_ITEM_AMMO3, SPRITE_GRAPHICS_ID_ITEM_AMMO3, enemy[5].pos_x, enemy[5].pos_y + 16);
							break;
						case 4:// Ammo 4
							if (!item[1].is_loaded) ITEM_LoadItem(1, ENTITY_ID_ITEM_AMMO4, SPRITE_GRAPHICS_ID_ITEM_AMMO4, enemy[5].pos_x, enemy[5].pos_y + 16);
							break;
						default:
							break;
					}
				...
				// Emeny throw items
				if (enemy[8].action_dead && (enemy[8].action_step == 1)) {
					switch (rand() % 8) {
						case 0:// Nothing
							break;
						case 1:// Medikit
							if (!item[2].is_loaded) ITEM_LoadItem(2, ENTITY_ID_ITEM_MEDIKIT, SPRITE_GRAPHICS_ID_ITEM_MEDIKIT, enemy[8].pos_x, enemy[8].pos_y + 16);
							break;
						case 2:// Grenades
							if (!item[2].is_loaded) ITEM_LoadItem(2, ENTITY_ID_ITEM_GRENADE, SPRITE_GRAPHICS_ID_ITEM_GRENADE, enemy[8].pos_x, enemy[8].pos_y + 16);
							break;
						case 3:// Ammo 3
							if (!item[2].is_loaded) ITEM_LoadItem(2, ENTITY_ID_ITEM_AMMO3, SPRITE_GRAPHICS_ID_ITEM_AMMO3, enemy[8].pos_x, enemy[8].pos_y + 16);
							break;
						case 4:// Ammo 4
							if (!item[2].is_loaded) ITEM_LoadItem(2, ENTITY_ID_ITEM_AMMO4, SPRITE_GRAPHICS_ID_ITEM_AMMO4, enemy[8].pos_x, enemy[8].pos_y + 16);
							break;
						default:
							break;
					}
