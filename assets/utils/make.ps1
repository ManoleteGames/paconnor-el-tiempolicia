...
python3 "$PSScriptRoot/makedat.py" "DIALOGGR.DAT" "INTRO.TXT" "NAMES.TXT" "GLOBAL.TXT" "CREDITS.TXT" "SCN1I.TXT" "SCN1H.TXT" "SCN1D.TXT" "SCN2I.TXT" "SCN2H.TXT" "SCN2D.TXT" "SCN3I.TXT" "SCN3H.TXT" "SCN3D.TXT" "SCN4I.TXT" "SCN4H.TXT" "SCN4D.TXT" "SCN5I.TXT" "SCN5H.TXT" "SCN5D.TXT" "SCN6I.TXT" "SCN6H.TXT" "SCN6D.TXT" "END.TXT"
