...
Remove-Item "$parentPath/images/logo/*.DAT"
Remove-Item "$parentPath/images/menu/*.DAT"
Remove-Item "$parentPath/images/intro/*.DAT"
Remove-Item "$parentPath/images/end/*.DAT"
Remove-Item "$parentPath/images/scn1/*.DAT"
Remove-Item "$parentPath/images/scn2/*.DAT"
Remove-Item "$parentPath/images/scn3/*.DAT"
Remove-Item "$parentPath/images/scn4/*.DAT"
Remove-Item "$parentPath/images/scn5/*.DAT"
Remove-Item "$parentPath/images/scn6/*.DAT"
Remove-Item "$parentPath/maps/scn1_1/*.DAT"
Remove-Item "$parentPath/maps/scn1_2/*.DAT"
Remove-Item "$parentPath/maps/scn2_1/*.DAT"
Remove-Item "$parentPath/maps/scn3_1/*.DAT"
Remove-Item "$parentPath/maps/scn3_2/*.DAT"
Remove-Item "$parentPath/maps/scn4_1/*.DAT"
Remove-Item "$parentPath/maps/scn4_2/*.DAT"
Remove-Item "$parentPath/maps/scn5_1/*.DAT"
Remove-Item "$parentPath/maps/scn5_2/*.DAT"
Remove-Item "$parentPath/maps/scn6_1/*.DAT"
Remove-Item "$parentPath/maps/scn6_2/*.DAT"
Remove-Item "$parentPath/palettes/*.DAT"
Remove-Item "$parentPath/sounds/*.DAT"
Remove-Item "$parentPath/sprites/cursor/*.DAT"
Remove-Item "$parentPath/sprites/actor/*.DAT"
Remove-Item "$parentPath/sprites/bullets/*.DAT"
Remove-Item "$parentPath/sprites/enemies/enemy1/*.DAT"
Remove-Item "$parentPath/sprites/enemies/enemy2/*.DAT"
Remove-Item "$parentPath/sprites/enemies/enemy3/*.DAT"
Remove-Item "$parentPath/sprites/enemies/enemy4/*.DAT"
Remove-Item "$parentPath/sprites/enemies/enemy5/*.DAT"
Remove-Item "$parentPath/sprites/enemies/enemy6/*.DAT"
Remove-Item "$parentPath/sprites/enemies/enemy7/*.DAT"
Remove-Item "$parentPath/sprites/enemies/enemy8/*.DAT"
Remove-Item "$parentPath/sprites/enemies/enemy9/*.DAT"
Remove-Item "$parentPath/sprites/enemies/enemy10/*.DAT"
Remove-Item "$parentPath/sprites/enemies/enemy11/*.DAT"
Remove-Item "$parentPath/sprites/enemies/enemy12/*.DAT"
Remove-Item "$parentPath/sprites/boss/boss1/*.DAT"
Remove-Item "$parentPath/sprites/boss/boss2/*.DAT"
Remove-Item "$parentPath/sprites/boss/boss3/*.DAT"
Remove-Item "$parentPath/sprites/boss/boss4/*.DAT"
Remove-Item "$parentPath/sprites/npcs/npc1/*.DAT"
Remove-Item "$parentPath/sprites/npcs/npc2/*.DAT"
Remove-Item "$parentPath/sprites/npcs/npc3/*.DAT"
Remove-Item "$parentPath/sprites/npcs/npc4/*.DAT"
Remove-Item "$parentPath/sprites/npcs/npc5/*.DAT"
Remove-Item "$parentPath/sprites/npcs/npc6/*.DAT"
Remove-Item "$parentPath/sprites/npcs/npc7/*.DAT"
Remove-Item "$parentPath/sprites/objects/object1/*.DAT"
Remove-Item "$parentPath/sprites/objects/object2/*.DAT"
Remove-Item "$parentPath/sprites/objects/object3/*.DAT"
Remove-Item "$parentPath/sprites/objects/object4/*.DAT"
Remove-Item "$parentPath/sprites/objects/object5/*.DAT"
Remove-Item "$parentPath/sprites/intro/*.DAT"
Remove-Item "$parentPath/sprites/misc/*.DAT"
Remove-Item "$parentPath/sprites/effects/*.DAT"
Remove-Item "$parentPath/sprites/panel/*.DAT"
Remove-Item "$parentPath/sprites/items/*.DAT"
Remove-Item "$parentPath/sprites/menu/*.DAT"
Remove-Item "$parentPath/tilesets/scn1_1/*.DAT"
Remove-Item "$parentPath/tilesets/scn1_2/*.DAT"
Remove-Item "$parentPath/tilesets/scn2_1/*.DAT"
Remove-Item "$parentPath/tilesets/scn3_1/*.DAT"
Remove-Item "$parentPath/tilesets/scn3_2/*.DAT"
Remove-Item "$parentPath/tilesets/scn4_1/*.DAT"
Remove-Item "$parentPath/tilesets/scn4_2/*.DAT"
Remove-Item "$parentPath/tilesets/scn5_1/*.DAT"
Remove-Item "$parentPath/tilesets/scn5_2/*.DAT"
Remove-Item "$parentPath/tilesets/scn6_1/*.DAT"
Remove-Item "$parentPath/tilesets/scn6_2/*.DAT"
Remove-Item "$parentPath/text/ES/*.DAT"
Remove-Item "$parentPath/text/EN/*.DAT"
Remove-Item "$parentPath/text/FR/*.DAT"
Remove-Item "$parentPath/text/GR/*.DAT"
...
python3 "$PSScriptRoot/makedat.py" "DIALOGES.DAT" "INTRO.TXT" "GLOBAL.TXT" "CREDITS.TXT" "SCN1I.TXT" "SCN1H.TXT" "SCN1D.TXT" "SCN2I.TXT" "SCN2H.TXT" "SCN2D.TXT" "SCN3I.TXT" "SCN3H.TXT" "SCN3D.TXT" "SCN4I.TXT" "SCN4H.TXT" "SCN4D.TXT" "SCN5I.TXT" "SCN5H.TXT" "SCN5D.TXT" "SCN6I.TXT" "SCN6H.TXT" "SCN6D.TXT" "END.TXT"
write-Host Generating english text dialog DAT file....
Set-Location -Path "$parentPath\text\EN"
python3 "$PSScriptRoot/makedat.py" "DIALOGEN.DAT" "INTRO.TXT" "GLOBAL.TXT" "CREDITS.TXT" "SCN1I.TXT" "SCN1H.TXT" "SCN1D.TXT" "SCN2I.TXT" "SCN2H.TXT" "SCN2D.TXT" "SCN3I.TXT" "SCN3H.TXT" "SCN3D.TXT" "SCN4I.TXT" "SCN4H.TXT" "SCN4D.TXT" "SCN5I.TXT" "SCN5H.TXT" "SCN5D.TXT" "SCN6I.TXT" "SCN6H.TXT" "SCN6D.TXT" "END.TXT" 
write-Host Generating french text dialog DAT file....
Set-Location -Path "$parentPath\text\FR"
python3 "$PSScriptRoot/makedat.py" "DIALOGFR.DAT" "INTRO.TXT" "GLOBAL.TXT" "CREDITS.TXT" "SCN1I.TXT" "SCN1H.TXT" "SCN1D.TXT" "SCN2I.TXT" "SCN2H.TXT" "SCN2D.TXT" "SCN3I.TXT" "SCN3H.TXT" "SCN3D.TXT" "SCN4I.TXT" "SCN4H.TXT" "SCN4D.TXT" "SCN5I.TXT" "SCN5H.TXT" "SCN5D.TXT" "SCN6I.TXT" "SCN6H.TXT" "SCN6D.TXT" "END.TXT"
write-Host Generating german text dialog DAT file....
Set-Location -Path "$parentPath\text\GR"
python3 "$PSScriptRoot/makedat.py" "DIALOGGR.DAT" "INTRO.TXT" "GLOBAL.TXT" "CREDITS.TXT" "SCN1I.TXT" "SCN1H.TXT" "SCN1D.TXT" "SCN2I.TXT" "SCN2H.TXT" "SCN2D.TXT" "SCN3I.TXT" "SCN3H.TXT" "SCN3D.TXT" "SCN4I.TXT" "SCN4H.TXT" "SCN4D.TXT" "SCN5I.TXT" "SCN5H.TXT" "SCN5D.TXT" "SCN6I.TXT" "SCN6H.TXT" "SCN6D.TXT" "END.TXT"
